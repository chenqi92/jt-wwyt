...
@Data
@Schema(description = "动土作业审批流转记录表", name = "t_dtzy_splz")
@TableName("t_dtzy_splz")
public class TDtzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = -33486867236736300L;
