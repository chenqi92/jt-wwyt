...
/**
 * 盲板抽堵作业审批流转记录表(t_mbcdzy_splz)表实体类
 *
 * @author lhh
...
@Data
@Schema(description = "盲板抽堵作业审批流转记录表", name = "t_mbcdzy_splz")
@TableName("t_mbcdzy_splz")
public class TMbcdzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = -97263924895889395L;
