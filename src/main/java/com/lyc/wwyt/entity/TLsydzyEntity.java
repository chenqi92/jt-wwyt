...
@Data
@Schema(description = "临时用电信息表", name = "t_lsydzy")
@RequiredIf(dependentField = "sfsstqy", field = "fssstid", fieldValue = "1")
@TableName("t_lsydzy")
public class TLsydzyEntity extends BaseEntity {

    private static final long serialVersionUID = -30979407624983560L;
    ...
    @Schema(description = "电源接入点及许可用电功率", name = "jrdydgl", implementation = String.class, maxLength = 100)
    @NotBlank(message = "电源接入点及许可用电功率不能为空!")
    @Size(max = 100, message = "电源接入点及许可用电功率不能超过100个字符(1个汉字记两个字符)!")
    private String jrdydgl;

    @Schema(description = "用电设备名称及额定功率", name = "sbmedgl", implementation = String.class, maxLength = 100)
    @NotBlank(message = "用电设备名称及额定功率不能为空!")
    @Size(max = 100, message = "用电设备名称及额定功率不能超过100个字符(1个汉字记两个字符)!")
    private String sbmedgl;

    @Schema(description = "工作电压", name = "gzdy", implementation = String.class, maxLength = 50)
    @NotBlank(message = "工作电压不能为空!")
    @Size(max = 50, message = "工作电压不能超过50个字符(1个汉字记两个字符)!")
    private String gzdy;

    @Schema(description = "用电人", name = "ydr", implementation = String.class, maxLength = 20)
    @Size(max = 20, message = "用电人不能超过20个字符(1个汉字记两个字符)!")
    private String ydr;
