...
@Data
@Schema(description = "受限空间作业信息表", name = "t_sxkjzy")
@RequiredIf(dependentField = "sfsstqy", field = "fssstid", fieldValue = "1")
@TableName("t_sxkjzy")
public class TSxkjzyEntity extends BaseEntity {

    private static final long serialVersionUID = 931785750362787671L;
    ...
    @Schema(description = "受限空间内原有介质名称", name = "yyjzmc", implementation = String.class, maxLength = 100)
    @Size(max = 100, message = "受限空间内原有介质名称不能超过100个字符(1个汉字记两个字符)!")
    private String yyjzmc;
