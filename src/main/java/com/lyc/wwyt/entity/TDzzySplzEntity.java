...
@Data
@Schema(description = "吊装作业审批流转记录表", name = "t_dzzy_splz")
@TableName("t_dzzy_splz")
public class TDzzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = 647536875101259024L;
