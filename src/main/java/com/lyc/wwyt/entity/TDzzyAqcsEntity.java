...
@Data
@Schema(description = "吊装作业安全措施表", name = "t_dzzy_aqcs")
@TableName("t_dzzy_aqcs")
public class TDzzyAqcsEntity extends BaseEntity {

    private static final long serialVersionUID = -54381625886996061L;
