...
@Data
@Schema(description = "高处作业信息安全措施表", name = "t_gczy_aqcs")
@TableName("t_gczy_aqcs")
public class TGczyAqcsEntity extends BaseEntity {

    private static final long serialVersionUID = -38148868776279197L;
