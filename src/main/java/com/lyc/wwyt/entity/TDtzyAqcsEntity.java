...
/**
 * 动土作业安全措施表(t_dtzy_aqcs)表实体类
 *
 * @author lhh
 * @since 2023-05-18 15:54:34
 */
@EqualsAndHashCode(callSuper = true)
@Data
@Schema(description = "动土作业安全措施表", name = "t_dtzy_aqcs")
@TableName("t_dtzy_aqcs")
public class TDtzyAqcsEntity extends BaseEntity {

    private static final long serialVersionUID = 387004176959134926L;
