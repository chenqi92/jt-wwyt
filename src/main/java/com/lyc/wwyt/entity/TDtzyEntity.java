...
@Data
@Schema(description = "动土作业信息表", name = "t_dtzy")
@RequiredIf(dependentField = "sfsstqy", field = "fssstid", fieldValue = "1")
@TableName("t_dtzy")
public class TDtzyEntity extends BaseEntity {

    private static final long serialVersionUID = -27864571096565025L;
    ...
    @Schema(description = "作业范围、方式", name = "zyfwfs", implementation = String.class, maxLength = 500)
    @Size(max = 500, message = "作业范围、方式不能超过500个字符(1个汉字记两个字符)!")
    private String zyfwfs;

    @Schema(description = "作业简图", name = "zyjt", implementation = String.class)
    private String zyjt;
    ...
    @Schema(description = "创建人", name = "createby", implementation = String.class, maxLength = 50)
    @NotBlank(message = "创建人不能为空!")
    @Size(max = 50, message = "创建人不能超过50个字符(1个汉字记两个字符)!")
    ...
    @Schema(description = "最后修改人", name = "updateby", implementation = String.class, maxLength = 1)
    @NotBlank(message = "最后修改人不能为空!")
    @Size(max = 1, message = "最后修改人不能超过1个字符(1个汉字记两个字符)!")
    private String updateby;

    @Schema(description = "删除标识", name = "deletemark", implementation = String.class, maxLength = 9)
    @NotBlank(message = "删除标识不能为空!")
    @Size(max = 9, message = "删除标识不能超过9个字符(1个汉字记两个字符)!")
    private String deletemark;

    @Schema(description = "企业编码", name = "companycode", implementation = Double.class, maxLength = 9)
