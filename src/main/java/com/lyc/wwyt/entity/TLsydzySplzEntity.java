...
/**
 * 临时用电作业审批流转记录表(t_lsydzy_splz)表实体类
 *
 * @author lhh
...
@Data
@Schema(description = "临时用电作业审批流转记录表", name = "t_lsydzy_splz")
@TableName("t_lsydzy_splz")
public class TLsydzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = -31374683046483027L;
    ...
    @Schema(description = "处理时间", name = "clsj", implementation = Integer.class, maxLength = 14)
