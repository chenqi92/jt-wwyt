...
@Data
@Schema(description = "断路作业审批流转记录表", name = "t_dlzy_splz")
@TableName("t_dlzy_splz")
public class TDlzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = -11408564589793681L;
