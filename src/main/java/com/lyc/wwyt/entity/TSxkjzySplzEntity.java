...
/**
 * 受限空间作业审批流转记录表(t_sxkjzy_splz)表实体类
 *
 * @author lhh
...
@Data
@Schema(description = "受限空间作业审批流转记录表", name = "t_sxkjzy_splz")
@TableName("t_sxkjzy_splz")
public class TSxkjzySplzEntity extends BaseEntity {

    private static final long serialVersionUID = -67709905539999107L;
