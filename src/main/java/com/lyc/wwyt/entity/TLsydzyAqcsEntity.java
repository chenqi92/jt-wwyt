...
@Data
@Schema(description = "临时用电安全措施表", name = "t_lsydzy_aqcs")
@TableName("t_lsydzy_aqcs")
public class TLsydzyAqcsEntity extends BaseEntity {

    private static final long serialVersionUID = -92274810657753834L;
    ...
    @Schema(description = "是否涉及", name = "sfsj", implementation = String.class, maxLength = 1)
    @NotBlank(message = "是否涉及不能为空!")
    @Size(max = 1, message = "是否涉及不能超过1个字符(1个汉字记两个字符)!")
    private String sfsj;
