...
@Data
@Schema(description = "动火作业安全措施表", name = "t_dhzy_aqcs")
@TableName("t_dhzy_aqcs")
public class TDhzyAqcsEntity extends BaseEntity {

    private static final long serialVersionUID = -99930134775461570L;
