...
@Data
@Schema(description = "高处作业信息表", name = "t_gczy")
@RequiredIf(dependentField = "sfsstqy", field = "fssstid", fieldValue = "1")
@TableName("t_gczy")
public class TGczyEntity extends BaseEntity {

    private static final long serialVersionUID = -64407808007957925L;
    ...
    @Schema(description = "作业高度（米）", name = "zygd", implementation = Double.class, maxLength = 3)
    @NotNull(message = "作业高度（米）不能为空")
    private Double zygd;

    @Schema(description = "作业级别", name = "zyjb", implementation = String.class)
