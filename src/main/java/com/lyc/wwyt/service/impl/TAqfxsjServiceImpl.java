...
public class TAqfxsjServiceImpl extends ServiceImpl<TAqfxsjDao, TAqfxsjEntity> implements TAqfxsjService {
     ...
     */
    @Override
    public List<TAqfxsjVO> selectList() {
        return this.tAqfxsjDao.selectList();
    }
     ...
     */
    @Override
    public IPage<TAqfxsjVO> selectPage(Page<TAqfxsjDTO> page, TAqfxsjDTO tAqfxsjDTO) {
        return this.tAqfxsjDao.selectList(page, tAqfxsjDTO);
    }
}
