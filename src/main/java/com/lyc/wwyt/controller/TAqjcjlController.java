...
public class TAqjcjlController {
    ...
    @ExportExcel(name = "安全检查记录表", sheets = @Sheet(sheetName = "t_aqjcjl"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_aqjcjl");
