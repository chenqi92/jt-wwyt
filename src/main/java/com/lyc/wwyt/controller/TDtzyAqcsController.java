...
public class TDtzyAqcsController {
     ...
     * 查询当前账户下所有动土作业安全措施表     *
     *
     * @return List<TDtzyAqcsEntity> 当前账户下所有动土作业安全措施表
     */
    @Operation(description = "查询动土作业安全措施表信息表数据", summary = "查询动土作业安全措施表信息表数据", tags = {"查询所有数据"})
    @GetMapping
    @Idempotent(expireTime = 180, info = "3分钟内最多请求一次!")
    public List<TDtzyAqcsVO> selectAll() {
        return this.tDtzyAqcsService.selectList();
    }

    /**
     * 分页查询当前账户下所有动土作业安全措施表     *
     *
     * @return List<TDtzyAqcsDTO> 分页当前账户下所有动土作业安全措施表
     */
    ...
    public IPage<TDtzyAqcsVO> selectPage(@ParameterObject Page<TDtzyAqcsDTO> page, @ParameterObject TDtzyAqcsDTO tDtzyAqcsDTO) {
        return this.tDtzyAqcsService.selectPage(page, tDtzyAqcsDTO);
    }
