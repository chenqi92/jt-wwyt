...
public class TScssjcxxController {
     ...
     * 查询当前账户下所有生产设施检查信息信息
     *
     * @return List<TScssjcxxEntity> 当前账户下所有生产设施检查信息信息
     */
    @Operation(description = "查询生产设施检查信息信息表数据", summary = "查询生产设施检查信息信息表数据", tags = {"查询所有数据"})
    @GetMapping
    @Idempotent(expireTime = 180, info = "3分钟内最多请求一次!")
    @ExportExcel(name = "生产设施检查信息", sheets = @Sheet(sheetName = "t_scssjcxx"), headGenerator = CustomHead.class)
    public List<TScssjcxxVO> selectAll(@ParameterObject TScssjcxxDTO tScssjcxxDTO) {
        return this.tScssjcxxService.queryList(tScssjcxxDTO);
    }

    /**
     * 分页查询当前账户下所有生产设施检查信息信息
     *
     * @return List<TScssjcxxDTO> 分页当前账户下所有生产设施检查信息信息
     */
    ...
    public IPage<TScssjcxxVO> selectPage(@ParameterObject Page<TScssjcxxDTO> page, @ParameterObject TScssjcxxDTO tScssjcxxDTO) {
        return this.tScssjcxxService.queryPage(page, tScssjcxxDTO);
    }
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_scssjcxx");
