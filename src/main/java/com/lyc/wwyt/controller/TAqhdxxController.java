...
public class TAqhdxxController {
    ...
    @ExportExcel(name = "安全活动信息表", sheets = @Sheet(sheetName = "t_aqhdxx"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_aqhdxx");
