...
public class TScsswxxxController {
     ...
     * 查询当前账户下所有生产设施维修信息     *
     *
     * @return List<TScsswxxxEntity> 当前账户下所有生产设施维修信息
     */
    @Operation(description = "查询生产设施维修信息信息表数据", summary = "查询生产设施维修信息信息表数据", tags = {"查询所有数据"})
    @GetMapping
    @Idempotent(expireTime = 180, info = "3分钟内最多请求一次!")
    public List<TScsswxxxVO> selectAll() {
        return this.tScsswxxxService.selectList();
    }

    /**
     * 分页查询当前账户下所有生产设施维修信息     *
     *
     * @return List<TScsswxxxDTO> 分页当前账户下所有生产设施维修信息
     */
    ...
    public IPage<TScsswxxxVO> selectPage(@ParameterObject Page<TScsswxxxDTO> page, @ParameterObject TScsswxxxDTO tScsswxxxDTO) {
        return this.tScsswxxxService.selectPage(page, tScsswxxxDTO);
    }
