...
public class TPxjhxxController {
    ...
    @ExportExcel(name = "培训计划信息表", sheets = @Sheet(sheetName = "t_pxjhxx"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_pxjhxx");
