...
public class TYjyaglxxController {
    ...
    @ExportExcel(name = "应急预案管理信息表", sheets = @Sheet(sheetName = "t_yjyaglxx"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_yjyaglxx");
