...
public class TQyryxxController {
     ...
     * 查询当前账户下所有企业人员信息表信息
     *
     * @return List<TQyryxxEntity> 当前账户下所有企业人员信息表信息
     */
    @Operation(description = "查询企业人员信息表信息表数据", summary = "查询企业人员信息表信息表数据", tags = {"查询所有数据"})
    @GetMapping
    @Idempotent(expireTime = 180, info = "3分钟内最多请求一次!")
    @ExportExcel(name = "企业人员信息表", sheets = @Sheet(sheetName = "t_qyryxx"), headGenerator = CustomHead.class)
    public List<TQyryxxVO> selectAll(@ParameterObject TQyryxxDTO tQyryxxDTO) {
        return this.tQyryxxService.queryList(tQyryxxDTO);
    }

    /**
     * 分页查询当前账户下所有企业人员信息表信息
     *
     * @return List<TQyryxxDTO> 分页当前账户下所有企业人员信息表信息
     */
    ...
    public IPage<TQyryxxVO> selectPage(@ParameterObject Page<TQyryxxDTO> page, @ParameterObject TQyryxxDTO tQyryxxDTO) {
        return this.tQyryxxService.queryPage(page, tQyryxxDTO);
    }
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_qyryxx");
