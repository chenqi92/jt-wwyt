...
public class TQyfxfbxxController {
    ...
    @ExportExcel(name = "企业安全风险分布信息表", sheets = @Sheet(sheetName = "t_qyfxfbxx"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_qyfxfbxx");
