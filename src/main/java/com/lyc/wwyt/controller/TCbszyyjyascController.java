...
public class TCbszyyjyascController {
    ...
    @ExportExcel(name = "承包商作业应急预案审查表", sheets = @Sheet(sheetName = "t_cbszyyjyasc"), headGenerator = CustomHead.class)
    ...
    public List<TableInfoVO> heads() {
        // 查询所有列名
        List<TableInfoVO> queryInfos = this.commonService.queryTableHeaders("t_cbszyyjyasc");
